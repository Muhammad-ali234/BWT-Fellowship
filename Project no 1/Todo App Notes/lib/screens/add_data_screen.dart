...
class _TextFieldValidationExampleState extends State<AddDataScreen> {
  ...
  // String? _validateTextField3(String? value) {
  //   if (value!.isEmpty) {
  //     return 'Please enter a value';
  //   }
  //   if (!value.contains('@')) {
                      ...
                      onPressed: () {
                        setState(() {
                          if (_formKey.currentState!.validate()) {
                            ...
                            id = int.parse(_textFieldController1.text);
